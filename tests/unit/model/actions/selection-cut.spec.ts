...
describe( "Selection cut action", () => {
    ...
    it( "should call the selection cut action with the appropriate values", () => {
        const commitSpy = vi.spyOn( store, "commit" );

        cutSelection( store );

        expect( commitSpy ).toHaveBeenCalledWith( "cutSelection", {
