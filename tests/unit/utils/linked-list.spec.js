...
describe('Linked list', () => {
    it('should by default be empty upon construction', () => {
        ...
        expect(null).toEqual(list.head); // expected list to not contain a head upon construction
        expect(null).toEqual(list.tail); // expected list to not contain a tail upon construction
    });
    ...
    it('should be able to add Objects to its internal list', () => {
        ...
        expect(0).toEqual(list._length); // expected list length to be 0 after construction

        const obj1node = list.add(obj1);

        expect(1).toEqual(list._length); // expected list length to be 1 after addition of an Object
        ...
        expect(obj1node.previous).toEqual(null); // expected added node to not have a previous node reference
        expect(obj1node.next).toEqual(null); // expected added node to not have a next node reference
    });
    ...
    it('should be able to add multiple Objects to its internal list', () => {
        ...
        expect(obj1node.previous).toEqual(null); // expected the first node not to reference a previous node
        expect(obj1node).toEqual(obj2node.previous); // expected the second nodes previous property to reference the 1st node
        expect(obj2node.next).toEqual(null); // expected the second node not to reference a next node
        ...
        expect(3).toEqual(list._length); // expected list length to be 3 after addition of 3 Objects
    });
    ...
    it('should be able to add an Object before an existing one', () => {
        ...
        expect(4).toEqual(list._length); // expected list length to be 4 after addition of 4 Objects
    });
    ...
    it('should be able to remove Objects from its internal list', () => {
        ...
        expect(obj3node).toEqual(list.tail); // expected list to have the last added Object as its tail
        expect(obj3node.previous).toEqual(null); // expected 3rd node to have no previous property after removal of all other nodes
        expect(obj3node.next).toEqual(null); // expected 3rd node to have no next property after removal of all other nodes

        list.remove(obj3node);

        expect(list.head).toEqual(null); // expected list to have no head after removing all its nodes
        expect(list.tail).toEqual(null); // expected list to have no tail after removing all its nodes
    });
    ...
    it('should be able to flush all Objects from its internal list at once', () => {
        ...
        expect(list.head).toEqual(null); // expected list to have no head after flushing
        expect(list.tail).toEqual(null); // expected list to have no head after flushing
    });
    ...
    it('should be able to remove Objects directly from their Node', () => {
        ...
        expect(2).toEqual(list._length); // expected list length to be 2 after removal of 2nd Node
        ...
        expect(1).toEqual(list._length); // expected list length to be 1 after removal of 1st Node

        obj3node.remove();

        expect(list.head).toEqual(null); // expected list to have no head after removal of all Nodes
        expect(list.tail).toEqual(null); // expected list to have no tail after removal of all Nodes
        expect(0).toEqual(list._length); // expected list length to be 0 after removal of all Nodes
    });
